...
export const activities: ActivityInfo[] = [
  ...
  { id: 'balloon',      title: '풍선 터뜨리기',  tagline: '같은 색 풍선을 터뜨려요!',   image: 'chars/cat.svg',      bg: '#FFD5D5', accent: '#FF4444' },
  { id: 'numbermemory', title: '숫자 기억하기',  tagline: '순서를 기억해봐요!',          image: 'chars/frog.svg',     bg: '#D5FFE9', accent: '#27AE60' },
  { id: 'minesweeper',  title: '지뢰찾기',       tagline: '안전한 칸을 찾아요!',         image: 'chars/fox.svg',      bg: '#FFF0D5', accent: '#E8731A' },
  { id: 'brickbreaker', title: '벽돌깨기',       tagline: '공으로 벽돌을 깨요!',         image: 'chars/deer.svg',     bg: '#F5E8D5', accent: '#8B5E3C' },
  { id: 'dinogame',     title: '달리기 게임',    tagline: '장애물을 피해요!',            image: 'chars/turtle.svg',   bg: '#D5F5E3', accent: '#3A8028' },
  { id: 'shortcutquiz', title: '단축키 퀴즈',    tagline: '단축키를 맞춰봐요!',          image: 'chars/keyboard.svg', bg: '#D5EEFF', accent: '#0066CC' },
  { id: 'whackmole',    title: '두더지 잡기',    tagline: '두더지를 잡아봐요!',          image: 'chars/mole.svg',     bg: '#F0E8D5', accent: '#8B5E3C' },
];
