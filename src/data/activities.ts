...
export const activities: ActivityInfo[] = [
  ...
  { id: 'hidden',       title: '숨은 친구 찾기', tagline: '어디에 숨었을까요?',          image: 'chars/fox.png',       bg: '#D5F5E3', accent: '#27AE60' },
  { id: 'designquiz',   title: '디자인 퀴즈',    tagline: '디자인 지식을 테스트해봐요!', image: 'chars/diploma.png',   bg: '#E9D5FF', accent: '#8E44AD' },
  ...
  { id: 'numbermemory', title: '숫자 기억하기',  tagline: '순서를 기억해봐요!',          image: 'chars/frog.png',      bg: '#D5FFE9', accent: '#27AE60' },
  { id: 'minesweeper',  title: '지뢰찾기',       tagline: '안전한 칸을 찾아요!',         image: 'chars/bear.png',      bg: '#FFF0D5', accent: '#E8731A' },
